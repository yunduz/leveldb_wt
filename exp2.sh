...
do
	...
	do
	    ...
	    echo env LD_LIBRARY_PATH=/cs/systems/home/yra3/repos/wiredtiger_before_stats_change/.libs:/cs/systems/home/yra3/repos/wiredtiger_before_stats_change/ext/compressors/snappy/.libs/ ./db_bench_wiredtiger  --cache_size=134217728 --use_lsm=1 --use_existing_db=1 --db=/tmpfs/leveldb_wt_use_rlu --benchmarks=readseq --threads=$i --reads=20000000 --read_stats=1 --wait=$freq
	    
	    env LD_LIBRARY_PATH=/cs/systems/home/yra3/repos/wiredtiger_before_stats_change/.libs:/cs/systems/home/yra3/repos/wiredtiger_before_stats_change/ext/compressors/snappy/.libs/ ./db_bench_wiredtiger  --cache_size=134217728 --use_lsm=1 --use_existing_db=1 --db=/tmpfs/leveldb_wt_use_rlu --benchmarks=readseq --threads=$i --reads=20000000 --read_stats=1 --wait=$freq >> logs/leveldb_before_${i}_${current_time}.log
